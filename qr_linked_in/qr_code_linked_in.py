...
#     # Ask for LinkedIn profile URL or username
...
#
#     final_img.save("qr_linkedin.png", quality=95)
#     print(f"✅ LinkedIn QR code created!")
#     print(f"📱 Shortlink: {shortlink}")
...
# print("Creating LinkedIn QR code with shortlink...")
